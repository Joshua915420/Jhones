...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-236526071-2">
</script>
<script>
      ...
      <div class="row">
        <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
          <div class="icon-box">
            ...
            <span class="ins">Investment App</span>
        ...
        <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
          <div class="icon-box">
            ...
            <span  class="ins">School App</span>
         ...
         <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
          <div class="icon-box">
            <div class="icon"><i class="bx bx-file"></i></div>
            <span  class="ins">Ecommerce App</span>
        ...
        <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
          <div class="icon-box">
            <div class="icon"><i class="bx bx-file"></i></div>
            <span  class="ins">Chatting App</span>
        ...
        <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0">
          <div class="icon-box">
            ...
            <span  class="ins">Online Banking App</span>
